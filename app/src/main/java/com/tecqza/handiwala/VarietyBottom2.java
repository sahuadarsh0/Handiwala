...
public class VarietyBottom2 extends BottomSheetDialogFragment {
    ...
    public VarietyBottom2(Context context, String product_name, String product_desc, ProductModel product, TextView item_count, TextView total) {
            ...
            holder.item_variety_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (product.counter > 0) {
                        ...
                        cart.deleteWhereProduct(Integer.parseInt(arrayList.get(position).id));
                    }
